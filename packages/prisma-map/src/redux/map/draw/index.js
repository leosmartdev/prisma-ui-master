 ...
 * -------------------------------------
 *
 * Controls for when the map is in draw mode. Here you can control which type of feature is being
 * drawn, as well as setting/getting the features on the draw layer.
 */
