 ...
 * ------------------------------------
 * NoteEdit
 * Textfield and save/create button for editing and creating
 * an incident note log entry.
 */
...
class NoteEdit extends React.Component {
  ...
  static propTypes = {
    ...
    /**
     * When true, the note is a search object. Otherwise, this is a normal note.
     */
    searchObject: PropTypes.bool,
    /** @private withStyles */
  ...
  componentWillReceiveProps(props) {
    if (props.note !== this.props.note) {
      this.setState({
        infoBannerText: __(
          'This note has been updated by another user. Your edits may override changes.',
        ),
      });
    }
  }
  ...
  onSave = () => {
    ...
    this.props.onSave(this.state.note, this.props.searchObject);
  };
  ...
  render() {
    ...
    if (searchObject) {
      placeholder = __('Add Search Object Information Here.');
    }
